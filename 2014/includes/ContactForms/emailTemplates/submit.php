...
"ContactForms1" => "admin@mavensandmoguls.com"
);
...
*/
	...
	foreach($obj as $prop => $value) {
		...
		if ($prop !='captcha' && $prop !='message')
	 			 		$formdataString .= '<tr><td align="left" style="font-family: arial,sans-serif; font-size: 14px; font-weight:bold; line-height: 20px !important; color: #C94A4B; padding-bottom: 20px;border-top:1px solid #ccc;padding-top:20px;">' . $prop . ':&nbsp; <span style="color: #000000;">' . $value . '</td></tr>';
	}
