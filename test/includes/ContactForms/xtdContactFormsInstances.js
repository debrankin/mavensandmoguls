...
var xtdContactFormsMessages = { 
	"email" 	: "Email is not correct.", // The error will appear when Email field is required but is not filled out	

	"website" 	: "Website is not correct.", // The error will appear when Website field is required but is not filled out

	"phone"	    : "Phone number is not correct.", // The error will appear when Phone field is required but is not filled out	
